...
HuiZhou_Data_Metas = ['来源链接',
                      HuiZhou_Enum_Metas.项目名称.name,
...
HuiZhou_Houst_Loop_Metas = ["项目名称",
                            ...
                            "是否查封"]
# 连云港
LianYunGang_Base_Url = 'http://www.lygfdc.com'
LianYunGang_Com_Loop_Metas=["项目名称","所属区域","项目座落","开工时间","竣工时间","项目用途","项目类别","社区规模","主力户型","项目幢数","总户数","设计单位","施工单位","监理单位","投资单位","物业管理企业","物业服务费用","项目建筑面积","建筑密度","住宅建筑面积","非住宅建筑面积","用地面积","绿化率","车位数","容积率"]
LianYunGang_Com_Data_Metas=["来源链接","项目名称","所属区域","项目座落","开工时间","竣工时间","项目用途","项目类别","社区规模","主力户型","项目幢数","总户数","设计单位","施工单位","监理单位","投资单位","物业管理企业","物业服务费用","项目建筑面积","建筑密度","住宅建筑面积","非住宅建筑面积","用地面积","绿化率","车位数","容积率"]
